...
const RegalaTova = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setFormularioEnviado(true)//mensaje envio ok despues de darle a enviar.
    };
    ...
    return (
        <>
            ...
            {formularioEnviado ? (
                // Si se ha enviado el formulario, muestra el mensaje de gracias
                <p className={styles.mensajeGracias}> Gracias por confiar en Tova, en breves contactaremos contigo para que vengas a recoger tu tarjeta regalo a nuestra tienda.</p>
            ) : (
